...
public class MoneyTest {
	...
	/*
	 * Motivation: checking the method testGetAmount in the Money class,
	 * we would like to be able to get amount of money. We are checking
	...
	/*
	 * Motivation: checking the method testGetCurrencyt in the Money class,
	 * we would like to be able to get the currency of money. We are checking
	 * whether it is working properly- returns correct values. 
	 */
	@Test
	...
	/*
	 * Motivation: checking the method testToString in the Money class,
	...
	/*
	 * Motivation: checking the method universalValue in the Money class,
	 * we would like to be able to check whether calculations for receiving a universal value
	 * are done correctly/
	 */
	@Test
	...
	/*
	 * Motivation: checking the method testEqualsMoney in the Money class,
	 * we would like to be able to check whether 2 values of Money are the same. They can
	...
	/*
	 * Motivation: checking the method testAdd in the Money class,
	 * we would like to be able to add an amount of money to the current amount. Checking
	 * calculations.
	 */
	@Test
	public void testAdd() {
	...
	/*
	 * Motivation: checking the method testAdd in the Money class,
	 * we would like to be able to subtract an amount of money to the current amount. Checking
	 * calculations.
	 */
	@Test
	public void testSub() {
	...
	/*
	 * Motivation: checking the method testAdd in the Money class,
	 * we would like to be able to check whether money equals 0.
	 */
	@Test
	...
	/*
	 * Motivation: checking the method testAdd in the Money class,
	 * we would like to be able to negate the value of money.
	 */
	@Test
	...
	/*
	 * Motivation: checking the method testAdd in the Money class,
	 * we would like to be able to compare values of money and distinguish between
